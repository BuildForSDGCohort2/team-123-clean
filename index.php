    	...
    	<div class="container">
    		<div class="row no-gutters d-flex align-items-center align-items-stretch">
    			<div class="col-md-4 d-flex align-items-center py-4">
    				<a class="navbar-brand" href="index.html">SafeBin <span>Together we Can!</span></a>
    			</div>
	    		<div class="col-lg-8 d-block">
		    		<div class="row d-flex">
					    ...
					    <div class="col-md topper d-flex align-items-center justify-content-end">
					    	<p class="mb-0">
					    		<a href="https://safebin.herokuapp.com/" class="btn py-2 px-3 btn-primary d-flex align-items-center justify-content-center">
					    			<span>Register</span>
					    		</a>
					    	</p>
					    </div>
      ...
      <div class="slider-item" style="background-image:url(images/bg_1.jpg);">
        ...
        <div class="container">
          ...
          <div class="col-md-6 ftco-animate">
            ...
            <p><a href="https://safebin.herokuapp.com/" class="btn btn-primary px-4 py-3 mt-3">Register</a></p>
          </div>
        </div>
        </div>
      </div>
    			...
    			<div class="col-md-6 align-items-stretch d-flex">
    				<div class="img img-video d-flex align-items-center" style="background-image: url(images/about-2.jpg);">
    					<div class="video justify-content-center">
								<a href="https://youtube.com/773778" class="icon-video popup-vimeo d-flex justify-content-center align-items-center">
      ...
      <div class="container">
              ...
              <div class="block-21 mb-4 d-flex">
                ...
                <div class="text">
                  ...
                  <div class="meta">
                    ...
                    <div><a href="#"><span class="icon-chat"></span> 200</a></div>
                  </div>
                </div>
              </div>
          ...
          <div class="col-md-6 col-lg-3">
            <div class="ftco-footer-widget mb-5 ml-md-4">
              ...
              <ul class="list-unstyled">
                ...
                <li><a href="#"><span class="ion-ios-arrow-round-forward mr-2"></span>Report</a></li>
        ...
        <div class="row">
          <div class="col-md-12 text-center">
            ...
            <p>
  Copyright &copy;<script>document.write(new Date().getFullYear());</script> All rights reserved | <a href="#">SafeBin</a>
  </p>
          </div>
        </div>
      </div>
